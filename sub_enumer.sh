...
#read -p "Enter domain name::" domain
#for rec in A AAAA CNAME;do
#echo "Target domain=" "$domain"
	#	echo "Checking $rec info using digtool"
#		ipv4=$(dig $domain $rec +short)
#echo "$ipv4"
#done
		}
		dns_enum
...
while read urls;do    #read and save to url variable
	echo "${urls#*//}"  >> urls.txt;      #test to see url printing and strip https and http  # is to indicate strip and wildcard is for http:// to *p:// like so  *//
